...
import {addclub} from './connection'
...
export default function FormTable(props) {
  ...
  const onSubmit = async(body) =>{
    ...
    var formData=new FormData();
        ...
        formData.append('moredesc',body.moredesc)
        formData.append('facultyhead',body.facultyhead)
        formData.append('facultyemail',body.facultyemail)
        formData.append('studenthead',body.studenthead)
