...
router.get('/getparticipantregistration/:id',backendrouter.getparticipantregistration)
router.delete('/deleteparticipantRegistration/:id',backendrouter.deleteparticipantRegistration)
router.get('/approveparticipantRegistration/:id',backendrouter.approveparticipantRegistration)
